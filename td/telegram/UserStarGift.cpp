...
UserStarGift::UserStarGift(Td *td, telegram_api::object_ptr<telegram_api::savedStarGift> &&gift, bool is_me)
  ...
  if (is_me && message_id_.is_valid() && sender_dialog_id_ != DialogId()) {
