...
TEST(W2UseAfterMoveContract, CommonDialogManagerComputesTotalCountBeforeMovingChatsVector) {
...
TEST(W2UseAfterMoveContract, DialogManagerComputesBlockedTotalCountBeforeMovingBlockedVector) {
...
TEST(W2UseAfterMoveContract, MessagesManagerComputesDialogTotalCountBeforeMovingDialogsVector) {
...
TEST(W2UseAfterMoveContract, RecentDialogListLambdaDoesNotDependOnMovedDialogIdsParameter) {
...
TEST(W2UseAfterMoveContract, SecretChatActorComputesFatalExpectationBeforeMovingError) {
...
TEST(W2UseAfterMoveContract, StickersManagerBuildsInputMediaWithoutTernaryDualMoveExpression) {
