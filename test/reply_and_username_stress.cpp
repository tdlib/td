...
TEST(ReplyAndUsernameStability, RepeatedSourceReadsKeepRequiredGuardsStable) {
...
TEST(ReplyAndUsernameStability, RepeatedSourceReadsKeepOrderingInvariantsStable) {
  constexpr int kIterations = 300;
