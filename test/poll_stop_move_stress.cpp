...
TEST(PollStopMoveStress, RepeatedSourceReadsKeepMovedStopPollOwnershipStable) {
  ...
  for (int i = 0; i < kIterations; i++) {
    ...
    ASSERT_TRUE(poll_manager_header.contains(
        "voidstop_poll(MessageFullIdmessage_full_id,td_api::object_ptr<td_api::ReplyMarkup>&&reply_markup,"
