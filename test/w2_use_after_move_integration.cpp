...
TEST(W2UseAfterMoveIntegration, AllGuardPatternsExistAcrossDeferredWave2Files) {
  struct Expectation {
    td::Slice path;
...
TEST(W2UseAfterMoveIntegration, LegacyUnsafePatternsAreAbsentAcrossDeferredWave2Files) {
  struct Forbidden {
    td::Slice path;
