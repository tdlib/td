...
TEST(PollRestrictionReasonIntegration, MessageContentHeaderExportsRestrictionReasonBuilderContract) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessageContent.h");
