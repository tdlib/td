...
TEST(W2BGuestMessageContract, SelfDialogSenderNormalizationMustSkipBusinessGuestLane) {
...
TEST(W2BGuestMessageContract, OutgoingExpectationMustAccountForBotBusinessViaSender) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessagesManager.cpp");
  auto normalized = normalize_for_contract(source);
...
TEST(W2BGuestMessageContract, OutgoingExpectationMustFailClosedOnBusinessViaSenderMarker) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessagesManager.cpp");
  auto normalized = normalize_for_contract(source);
...
TEST(W2BGuestMessageContract, ScheduledMessagesMustDropPinnedFlagBeforeMessageConstruction) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessagesManager.cpp");
  auto normalized = normalize_for_contract(source);
...
TEST(W2BGuestMessageContract, BusinessGuestLaneMustSkipMessageTopicFixup) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessagesManager.cpp");
  auto normalized = normalize_for_contract(source);

  ASSERT_TRUE(
      normalized.find("if(!is_business_message){td->messages_manager_->fix_message_topic(dialog_id,message.get(),"
                      "false);}") != td::string::npos);
}

TEST(W2BGuestMessageContract, HideEditDateGuardMustBeSingleFailClosedPredicate) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessagesManager.cpp");
  auto normalized = normalize_for_contract(source);
...
TEST(W2BGuestMessageContract, ReplyToStoryValidationMustStayFailClosedOutsideBusinessLane) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessagesManager.cpp");
  auto normalized = normalize_for_contract(source);
...
TEST(W2BGuestMessageContract, RegularUpdatePathMustKeepBusinessLaneDisabledDuringParsingAndConstruction) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessagesManager.cpp");
  auto normalized = normalize_for_contract(source);
...
TEST(W2BGuestMessageContract, BusinessMessageObjectPathMustPropagateBusinessLaneEndToEnd) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessagesManager.cpp");
  auto normalized = normalize_for_contract(source);
...
TEST(W2BGuestMessageContract, EventLogPathMustStayOutOfBusinessLane) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessagesManager.cpp");
  auto normalized = normalize_for_contract(source);
...
TEST(W2BGuestMessageContract, ScheduledMessagesMustSanitizeMutableSubobjectsBeforeConstruction) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessagesManager.cpp");
  auto normalized = normalize_for_contract(source);
