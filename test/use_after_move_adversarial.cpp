...
TEST(UseAfterMoveAdversarial, CommonDialogManagerNoInlineMovedVectorSizeRead) {
...
TEST(UseAfterMoveAdversarial, DialogManagerNoInlineMovedBlockedVectorSizeRead) {
...
TEST(UseAfterMoveAdversarial, MessagesManagerNoInlineMovedDialogsVectorSizeRead) {
...
TEST(UseAfterMoveAdversarial, RecentDialogListNoNamedMovedDialogIdsLambdaParameter) {
...
TEST(UseAfterMoveAdversarial, SecretChatActorNoInlinePredicateWithMovedErrorArgument) {
...
TEST(UseAfterMoveAdversarial, StickersManagerNoTernaryDualMoveOfInputFile) {
