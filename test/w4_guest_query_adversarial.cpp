...
TEST(W4GuestQueryAdversarial, LegacyGuestCapabilityNameMustNotReappear) {
...
TEST(W4GuestQueryAdversarial, GuestTopPeerCategoryMustNotAliasInlineBots) {
...
TEST(W4GuestQueryAdversarial, GuestUpdatePathMustNotSkipIdentifierValidation) {
...
TEST(W4GuestQueryAdversarial, GuestUpdatePathMustNotAcceptNegativeIdentifiers) {
...
TEST(W4GuestQueryAdversarial, GuestUpdatePathMustNotConvertMessagesBeforeIdentifierValidation) {
  auto normalized = read_normalized("td/telegram/UpdatesManager.cpp");
...
TEST(W4GuestQueryAdversarial, GuestUpdateQtsHandlerMustNotDegradeToNoopPromisePath) {
  auto normalized = read_normalized("td/telegram/UpdatesManager.cpp");
...
TEST(W4GuestQueryAdversarial, GuestAnswerPathMustNotForwardUncheckedIdentifiers) {
...
TEST(W4GuestQueryAdversarial, GuestTopDialogFilteringMustNotIgnoreGuestBotCapability) {
...
TEST(W4GuestQueryAdversarial, GuestBotTopDialogPathMustNotApplyUngatedGuestRating) {
  auto normalized = read_normalized("td/telegram/MessagesManager.cpp");

  auto guest_gate_pos = normalized.find("if(m->guest_bot_via_dialog_id.is_valid()){");
...
TEST(W4GuestQueryAdversarial, UserTypeBotConstructionMustNotOmitGuestCapabilityField) {
...
TEST(W4GuestQueryAdversarial, RegularMessageObjectMustNotDropGuestCallerIdentifier) {
...
TEST(W4GuestQueryAdversarial, GuestCallerLiveLocationPathsMustNotUseLegacyUngatedPredicates) {
  auto normalized = read_normalized("td/telegram/MessagesManager.cpp");
