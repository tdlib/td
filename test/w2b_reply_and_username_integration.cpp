...
TEST(W2BReplyAndUsernameIntegration, RequiredWave2BGuardPatternsExistAcrossAllTouchedFiles) {
...
TEST(W2BReplyAndUsernameIntegration, LegacyWave2BUnsafePatternsRemainAbsentAcrossAllTouchedFiles) {
