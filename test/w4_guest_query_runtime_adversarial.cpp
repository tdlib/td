...
TEST(W4GuestQueryRuntimeAdversarial, ParsesWellFormedGuestQueryFixtureWithReferences) {
...
TEST(W4GuestQueryRuntimeAdversarial, RejectsUnknownConstructorFixtureFailClosed) {
...
TEST(W4GuestQueryRuntimeAdversarial, RejectsNegativeFlagsFixtureFailClosed) {
...
TEST(W4GuestQueryRuntimeAdversarial, RejectsTruncatedGuestQueryFixtureFailClosed) {
...
TEST(W4GuestQueryRuntimeAdversarial, RejectsCorruptedReferenceVectorMarkerFailClosed) {
...
TEST(W4GuestQueryRuntimeAdversarial, LightFuzzDeterministicBitFlipMutationsAreFailClosedOrParsable) {
...
TEST(W4GuestQueryRuntimeAdversarial, StressRepeatedMalformedFixturesRemainFailClosed) {
