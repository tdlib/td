...
TEST(HandshakeFingerprintCardinalityIntegration, SingleFingerprintFailsBeforeRsaLookup) {
...
TEST(HandshakeFingerprintCardinalityIntegration, MinimumFingerprintSetStillUsesPinnedLookup) {
  td::net_health::reset_net_monitor_for_tests();
