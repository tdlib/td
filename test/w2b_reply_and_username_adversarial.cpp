...
TEST(W2BReplyAndUsernameAdversarial, DraftMessageParseMustNotKeepLegacyYetUnsentReplyPathUntouched) {
...
TEST(W2BReplyAndUsernameAdversarial, InvalidReplyRejectionMustNotRetainStaleMessagePointer) {
...
TEST(W2BReplyAndUsernameAdversarial, RestoreReplyMustNotBindYetUnsentNonForwardTargets) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessagesManager.cpp");
  auto normalized = normalize_for_contract(source);
...
TEST(W2BReplyAndUsernameAdversarial, RestoreReplyMustNotUpdateUsingStaleRepliedMessageId) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessagesManager.cpp");
  auto normalized = normalize_for_contract(source);
...
TEST(W2BReplyAndUsernameAdversarial, UsernamePurchaseHandlingMustNotDependOnPhoneCountryHeuristics) {
