...
TEST(PollOptionVoterCountAdversarial, StorePathMustNotEmitVoterCountWhenAbsenceFlagIsSet) {
...
TEST(PollOptionVoterCountAdversarial, ParsePathMustNotReadVoterCountWhenAbsenceFlagIsSet) {
  auto source = read_normalized("td/telegram/PollOption.hpp");
...
TEST(PollOptionVoterCountAdversarial, StoreAndParseMustNotUseLegacyPresenceBitNames) {
  auto source = read_normalized("td/telegram/PollOption.hpp");
