...
TEST(W2BReplyAndUsernameRuntimeContract, LegacyDraftParsePathInvokesSharedYetUnsentSanitizer) {
...
TEST(W2BReplyAndUsernameRuntimeContract, ModernDraftParsePathStillInvokesSharedYetUnsentSanitizer) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/DraftMessage.hpp");
  auto normalized = normalize_for_contract(source);
...
TEST(W2BReplyAndUsernameRuntimeContract, InvalidReplyRejectionClearsMessageIdBeforeUnknownServerReplyAllowance) {
...
TEST(W2BReplyAndUsernameRuntimeContract, RestoreReplyUsesResolvedMessageIdForUpdatePath) {
  auto source = td::mtproto::test::read_repo_text_file("td/telegram/MessagesManager.cpp");
  auto normalized = normalize_for_contract(source);
...
TEST(W2BReplyAndUsernameRuntimeContract, LegacyDraftParseClearsScheduledYetUnsentReplyAtRuntime) {
...
TEST(W2BReplyAndUsernameRuntimeContract, ModernDraftParseClearsSameChatScheduledYetUnsentReplyAtRuntime) {
...
TEST(W2BReplyAndUsernameRuntimeContract, ModernDraftParseKeepsExternalYetUnsentReplyAtRuntime) {
...
TEST(W2BReplyAndUsernameRuntimeContract, ModernDraftParseKeepsExternalServerReplyAtRuntime) {
...
TEST(W2BReplyAndUsernameRuntimeContract, ModernDraftParseLightFuzzDropsYetUnsentRepliesFailClosed) {
