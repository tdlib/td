...
TEST(GuestQueryServerResultRuntime, ParsesInputBotInlineMessageIdResultIntoInlineMessageId) {
...
TEST(GuestQueryServerResultRuntime, ParsesInputBotInlineMessageId64ResultIntoInlineMessageId) {
...
TEST(GuestQueryServerResultRuntime, RejectsInputBotInlineMessageIdResultWithInvalidDcIdFailClosed) {
...
TEST(GuestQueryServerResultRuntime, RejectsInputBotInlineMessageId64ResultWithInvalidDcIdFailClosed) {
...
TEST(GuestQueryServerResultRuntime, RejectsUnknownConstructorFailClosed) {
...
TEST(GuestQueryServerResultRuntime, RejectsTruncatedResultPacketFailClosed) {
  auto packet =
...
TEST(GuestQueryServerResultRuntime, RejectsTrailingGarbageFailClosed) {
  auto packet =
...
TEST(GuestQueryServerResultRuntime, StressRepeatedMalformedPacketsRemainFailClosed) {
